...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'User'
        db.create_table(u'claritick_user', (
            ...
            ('email', self.gf('django.db.models.fields.EmailField')(db_index=True, max_length=256, blank=True)),
            ...
            ('security_level', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'claritick', ['User'])

        # Adding M2M table for field groups on 'User'
        m2m_table_name = db.shorten_name(u'claritick_user_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'claritick.user'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'User'
        m2m_table_name = db.shorten_name(u'claritick_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'claritick.user'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'User'
        db.delete_table(u'claritick_user')

        # Removing M2M table for field groups on 'User'
        db.delete_table(db.shorten_name(u'claritick_user_groups'))

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table(db.shorten_name(u'claritick_user_user_permissions'))
