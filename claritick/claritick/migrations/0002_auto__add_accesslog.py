...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'claritick_accesslog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='login_accesslog', null=True, to=orm['claritick.User'])),
        ...
        db.send_create_signal(u'claritick', ['AccessLog'])


    def backwards(self, orm):
        # Deleting model 'AccessLog'
        db.delete_table(u'claritick_accesslog')
    ...
    models = {
        ...
        u'claritick.accesslog': {
            'Meta': {'ordering': "['-date']", 'object_name': 'AccessLog'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.GenericIPAddressField', [], {'max_length': '39', 'null': 'True', 'blank': 'True'}),
            'message': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'login_accesslog'", 'null': 'True', 'to': u"orm['claritick.User']"}),
